...
const Uses = () => {
  ...
  return (
    <Fragment>
      <Helmet>
        <title>Uses | Husnul Jahaneer</title>
        <meta
          name="description"
              ...
              <ProjectSectionText>
                <ul>
                  <li>
                    ...
                    <Link href="https://www.figma.com/@jahneeer">a few plugins</Link> that
                    you can install.
                  </li>
                  <li>
              ...
              <ProjectSectionText>
                <ul>
                  ...
                  <li>
                    ...
                    <Link href="https://storybook.jahneer.ninja">
            ...
            <ProjectTextRow stretch width="m">
              ...
              <Table>
                <TableRow>
                  ...
                  <TableCell>Intel(R) Core(TM) i5-8250U CPU @ 1.60GHz (8 CPUs)</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>GPU</strong>
                  </TableCell>
                  <TableCell>NVIDIA GeForce 940MX</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>Memory</strong>
                  </TableCell>
                  <TableCell>Crucial 8GB DDR4-2400 SODIMM + 8GB 2400</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>1080p IPS 144hz SAMSUNG LC27FG73FQWXXL </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>Keyboard</strong>
                  </TableCell>
                  <TableCell>ASUS TUF Gaming K3 - RA05 </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>Mouse</strong>
                  </TableCell>
                  <TableCell>Logitech G300S</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>Laptop</strong>
                  </TableCell>
                  <TableCell>2018 HP Pavilion 15</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>Headphones</strong>
                  </TableCell>
                  <TableCell>JBL BT/Apple Airpods</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
